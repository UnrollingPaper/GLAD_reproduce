...
def main():
    a_pred = np.array([[0.74, 0.02, 0.01, 0, 0], [0.02, 1.25, 0, 0, 0], [0.01, 0, 0.79, 0, 0], [0, 0, 0, 0.81, 0],
                       [0, 0, 0, 0, 0.78]])
    # sign match check
    a_pred2 = np.array([[1.33, 0.32, 0, 0, 0], [0.32, 1.33, 0.02, 0, 0.08], [0, 0.02, 1.33, 0, 0], [0, 0, 0, 1.33, 0],
                        [0, 0.08, 0, 0, 1.33]])

    a_true = np.array([[1.33, 0.32, 0, 0, 0], [0.32, 1.33, -0.02, 0, -0.08], [0, -0.02, 1.33, 0, 0], [0, 0, 0, 1.33, 0],
                       [0, -0.08, 0, 0, 1.33]])
    print(a_pred, a_true)
